...
HTTPClient http;
String url;
String API = "5T83TEVQK1D4NJUK"; //thingspeak website api 
String FieldNo = "1";
...
void SendGETRequest(float data) {
  ...
  url += "=";
  url += data;
 // http://api.thingspeak.com/update?api_key=5T83TEVQK1D4NJUK&field=data
...
void ConnectToWifi() {
  WiFi.mode(WIFI_STA);
  WiFi.begin("UIU-STUDENT", "12345678"); //wifi ssid and password
